...
class ProductDetailsModel {
  ...
  factory ProductDetailsModel.fromSnapshot(DocumentSnapshot<Map<String, dynamic>> jsonData) {
  ...
  static Future<void> updateProductRecord(ProductDetailsModel editedProductData) async {
    final productTableObject = await FirebaseFirestore.instance
        .collection('Product')
  ...
  static Future<void> deleteProductRecord(ProductDetailsModel editedProductData) async {
    final productTableObject = await FirebaseFirestore.instance
        .collection('Product')
        .doc(editedProductData.id)
        .delete();
